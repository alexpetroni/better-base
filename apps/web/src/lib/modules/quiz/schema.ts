...
export const quizzes = pgTable('quizzes', {
	...
	scoring: jsonb('scoring').notNull().$type<ScoringConfig>().default({ questions: {}, bands: [] }),
...
export const quizResults = pgTable(
	...
	(table) => [index('quiz_results_quiz_id_created_at_idx').on(table.quizId, table.createdAt)]
);
